...
var G__4047 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__4047;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__4048 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__4048,ch);
...
if(("\\" === ch__$1)){
var ch_4049__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_4049__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_4049__$2);
} else {
}

var G__4050 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__4050;
continue;
}
}
...
var vec__4058 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4058,(0),null);
var start_column = cljs.core.nth.call(null,vec__4058,(1),null);
...
var G__4061 = cljs.core.conj_BANG_.call(null,a,form);
a = G__4061;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__4062 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__4063 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__4063;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__4062;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__4064 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4064,(0),null);
var start_column = cljs.core.nth.call(null,vec__4064,(1),null);
...
var vec__4067 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4067,(0),null);
var end_column = cljs.core.nth.call(null,vec__4067,(1),null);
...
var vec__4070 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4070,(0),null);
var start_column = cljs.core.nth.call(null,vec__4070,(1),null);
...
var vec__4073 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4073,(0),null);
var end_column = cljs.core.nth.call(null,vec__4073,(1),null);
...
var vec__4076 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4076,(0),null);
var start_column = cljs.core.nth.call(null,vec__4076,(1),null);
...
var vec__4079 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4079,(0),null);
var end_column = cljs.core.nth.call(null,vec__4079,(1),null);
...
var sb = (function (){var G__4082 = (new goog.string.StringBuffer());
G__4082.append(initch);
...
var G__4084 = (function (){var G__4083 = sb;
G__4083.append(ch);

return G__4083;
})();
var G__4085 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__4084;
ch = G__4085;
continue;
}
...
switch (G__4088) {
case "\\":
var G__4092 = (function (){var G__4089 = sb;
G__4089.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__4089;
})();
var G__4093 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__4092;
ch = G__4093;
continue;
...
break;
default:
var G__4094 = (function (){var G__4090 = sb;
G__4090.append(ch);

return G__4090;
})();
var G__4095 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__4094;
ch = G__4095;
continue;
...
var vec__4096 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4096,(0),null);
var end_column = cljs.core.nth.call(null,vec__4096,(1),null);
...
var vec__4099 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4099,(0),null);
var column = cljs.core.nth.call(null,vec__4099,(1),null);
...
var vec__4104 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4104,(0),null);
var column = cljs.core.nth.call(null,vec__4104,(1),null);
...
var vec__4109 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4109,(0),null);
var column = cljs.core.nth.call(null,vec__4109,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__4114 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4114,(0),null);
var start_column = cljs.core.nth.call(null,vec__4114,(1),null);
...
var vec__4117 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4117,(0),null);
var end_column = cljs.core.nth.call(null,vec__4117,(1),null);
...
var G__4120 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__4120,true,null,opts,pending_forms);
...
var G__4121 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__4121)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__4121)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__4121)){
...
var _STAR_suppress_read_STAR__orig_val__4122 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__4123 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__4123;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__4122;
}});
...
var G__4124 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__4124,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__4124,rdr,first_line);
...
var G__4128 = matched;
var G__4129 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__4128;
finished = G__4129;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__4130 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__4131 = (function (){var or__4131__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__4131;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__4130;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__4132 = cljs.tools.reader.arg_env;
var arg_env_temp_val__4133 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__4133;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__4134 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__4134,"(");
...
var G__4135 = (i + (1));
var G__4136 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4131__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__4132;
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__4137 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__4137);
...
var G__4138 = cljs.core.next.call(null,s__$1);
var G__4139 = ret;
s__$1 = G__4138;
r = G__4139;
continue;
...
var G__4140 = cljs.core.next.call(null,s);
var G__4141 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__4140;
key_vals = G__4141;
continue;
} else {
...
var gensym_env_orig_val__4145 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__4146 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__4146;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__4145;
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__4147 = token;
var G__4147__$1 = (((G__4147 == null))?null:cljs.core.subs.call(null,G__4147,(1)));
var G__4147__$2 = (((G__4147__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__4147__$1));
var G__4147__$3 = (((G__4147__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__4147__$2));
var G__4147__$4 = (((G__4147__$3 == null))?null:cljs.core.symbol.call(null,G__4147__$3));
if((G__4147__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__4147__$4);
}
})():(function (){var G__4148 = token;
var G__4148__$1 = (((G__4148 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__4148));
if((G__4148__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__4148__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
}catch (e4155){if((e4155 instanceof Error)){
var e = e4155;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__4159,reader){
...
var opts = map__4160__$1;
var eof = cljs.core.get.call(null,map__4160__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
args__4736__auto__.push((arguments[i__4731__auto___4169]));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq4166){
var G__4167 = cljs.core.first.call(null,seq4166);
var seq4166__$1 = cljs.core.next.call(null,seq4166);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__4167,seq4166__$1);
});
